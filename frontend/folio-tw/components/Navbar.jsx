    ...
    <div
      ...
      className={
        shadow
          ...
          : 'fixed w-full h-20 z-[100] bg-slate-300'
      }
    >
      <div className='flex items-center justify-between w-full h-full px-2 sticky-top 2xl:px-16'>
        <Link href='/'>
          <span className='font-serif text-2xl font-bold tracking-widest'>
            <span className='text-4xl text-blue-600 '>G</span>illespie.
          </span>
        </Link>
        <div>
        ...
        >
          <div>
            <div className='flex items-center justify-between w-full'>
              ...
              <div
                onClick={handleNav}
                className='p-3 rounded-full shadow-lg cursor-pointer shadow-slate-300'
              >
                <AiOutlineClose />
              </div>
            </div>
          ...
          <div className='flex flex-col py-4'>
            ...
            <div className='pt-40'>
              <p className='tracking-widest text-indigo-500 uppercase'>
                Let&#39;s Connect
              </p>
